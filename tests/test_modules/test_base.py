...
class TestMutationDecorator:
    def test_register_mutation_fn(self):
    ...
    def test_mutation_calls_recreate_network(self):
    ...
    def test_mutation_with_recreate_kwargs(self):
    ...
    def test_mutation_with_args_kwargs(self):
...
class TestEvolvableModuleInit:
    def test_evolvable_module_initialization(self):
        class DummyEvolvableModule(EvolvableModule):
            def forward(self, x):
                pass
...
class TestEvolvableModuleGetMutationMethods:
    def test_evolvable_module_get_mutation_methods(self):
        class DummyEvolvableModule(EvolvableModule):
            @mutation(MutationType.NODE)
            def dummy_mutation(self):
                return {"mutation": "dummy"}
    ...
    def test_inherited_evolvable_module_mutation_methods(self):
        ...
        assert (
            mutation_methods["inherited_mutation"]._mutation_type == MutationType.LAYER
        )


class TestEvolvableModuleClone:
    def test_evolvable_module_clone(self):
        class DummyEvolvableModule(EvolvableModule):
            def forward(self, x):
                pass
    ...
    def test_clone_nested_mutation_methods_and_wrapper_change_activation(self):
...
class TestEvolvableModuleDisableMutations:
    def test_evolvable_module_make_unevolvable(self):
        class DummyEvolvableModule(EvolvableModule):
            @mutation(MutationType.NODE)
            def dummy_mutation(self):
                return {"mutation": "dummy"}
...
class TestEvolvableModuleSampleMutationMethod:
    def test_evolvable_module_sample_mutation_method(self):
        class DummyEvolvableModule(EvolvableModule):
            @mutation(MutationType.NODE)
            def dummy_mutation(self):
                return {"mutation": "dummy"}
    ...
    def test_evolvable_module_sample_mutation_method_raises_when_no_methods(self):
...
class TestEvolvableModuleSetattr:
    def test_evolvable_module_with_evolvable_attributes(self):
    ...
    def test_setattr_invalid_mutation_type_raises(self):
        class BadMethod:
...
class TestEvolvableModuleProperties:
    def test_base_properties_setters_and_errors(self):
        class Child(EvolvableModule):
            def forward(self, x):
                return x
        ...
        with pytest.raises(
            NotImplementedError, match="forward method must be implemented"
        ):
...
class TestEvolvableModuleResetNoise:
    def test_module_utilities_and_noise_and_probs(self):
...
class TestEvolvableModuleStaticHelpers:
    def test_preserve_parameters_and_init_weights_gaussian(self):
...
######### Test ModuleDict #########
class TestEvolvableWrapperInit:
    def test_evolvable_wrapper_duplicate_mutation_method_raises(self):
    ...
    def test_evolvable_wrapper_initialization(self):
...
class TestModuleDictInit:
    def test_module_dict_initialization(self):
...
class TestModuleDictGetMutationMethods:
    def test_module_dict_mutation_methods(self):
...
class TestModuleDictModules:
    def test_module_dict_access_methods(self):
...
class TestEvolvableWrapperGetMutationMethods:
    def test_evolvable_wrapper_mutation_methods(self):
        ...
        assert (
            wrapper_methods["dummy_node_mutation"]._mutation_type == MutationType.NODE
        )
        assert (
            wrapper_methods["dummy_layer_mutation"]._mutation_type == MutationType.LAYER
        )
...
class TestEvolvableWrapperMutation:
    def test_evolvable_wrapper_mutation_execution(self):
...
class TestEvolvableWrapperForward:
    def test_evolvable_wrapper_forward(self):
...
class TestMutationContextExit:
    def test_mutation_context_filters_recreate_kwargs_and_calls_hooks(self):
...
class TestMutationContextResolveFinalMutationAttr:
    def test_mutation_context_resolve_nested_and_wrapper_paths(self):
        class Child(EvolvableModule):
            @mutation(MutationType.NODE)
            def mut(self):
                return {}
...
class TestMutationWrapper:
    def test_mutation_wrapper_returns_none_for_disabled_attr(self):
        class Dummy(EvolvableModule):
            @mutation(MutationType.NODE)
            def mut(self):
                return {}
...
class TestModuleDictActivation:
    def test_module_dict_activation_single_value(self):
...
class TestModuleDictFilterMutationMethods:
    def test_module_dict_filter_mutation_methods(self):
        class A(EvolvableModule):
            @mutation(MutationType.NODE)
            def mut_a(self):
                return {}
    ...
    def test_module_dict_additional_branches(self):
        class A(EvolvableModule):
            @mutation(MutationType.NODE)
            def mut(self):
                return {}
