...
class TestValueNetworkInit:
    ...
    def test_value_function_initialization(
        self, observation_space, encoder_type, request
    ):
    ...
    def test_value_function_initialization_recurrent(self, vector_space):
    ...
    def test_value_function_initialization_simba(self, vector_space):
...
class TestValueNetworkMutationMethods:
    @pytest.mark.parametrize(
        "observation_space",
...
class TestValueNetworkForward:
    ...
    def test_value_function_forward(self, observation_space: spaces.Space, request):
        observation_space = request.getfixturevalue(observation_space)
...
class TestValueNetworkClone:
    @pytest.mark.parametrize(
        "observation_space",
        ["dict_space", "discrete_space", "vector_space", "image_space"],
    )
    def test_value_function_clone(self, observation_space: spaces.Space, request):
        observation_space = request.getfixturevalue(observation_space)
