...
class TestRainbowDQNGetAction:
    ...
    def test_get_action_training_false(self, vector_space, discrete_space):
...
class TestRainbowDQNLearn:
    ...
    def test_learns_from_experiences_n_step(
        ...
        # Call the learn method
        loss, new_idxs, new_priorities = dqn.learn(
            experiences, n_experiences, per=False
        )
