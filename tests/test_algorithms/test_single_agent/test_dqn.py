...
class TestDQNGetAction:
    ...
    def test_dict_obs_without_mask(self, dict_space, discrete_space):
...
class TestDQNLearn:
    def test_handles_one_dim_actions(self, vector_space, discrete_space):
        batch_size = 64
...
class TestDQNSoftUpdate:
    def test_target_matches_polyak_average(self, vector_space, discrete_space):
...
class TestDQNClone:
    def test_returns_identical_agent(self, vector_space, discrete_space):
    ...
    def test_assigns_new_index(self, vector_space, discrete_space):
        dqn = DummyDQN(vector_space, discrete_space)
    ...
    def test_after_learning_preserves_state_dicts(self, vector_space, discrete_space):
        batch_size = 8
        dqn = DQN(vector_space, discrete_space)
