...
class TestTD3Init:
    ...
    def test_initialize_td3_with_incorrect_actor_net(self, vector_space):
        actor_network = "dummy"
...
class TestTD3GetAction:
    ...
    def test_returns_expected_action_float64(self, discrete_space):
        action_space = spaces.Box(low=-1, high=1, shape=(2,))
...
class TestTD3SoftUpdate:
    ...
    def test_soft_update(self, vector_space):
...
class TestTD3Clone:
    ...
    def test_clone_returns_identical_agent(
        self, observation_space, vector_space, request
    ):
        observation_space = request.getfixturevalue(observation_space)
    ...
    def test_clone_after_learning(self, vector_space):
        batch_size = 8
        td3 = TD3(vector_space, copy.deepcopy(vector_space))
...
class TestTD3ShareEncoderParameters:
