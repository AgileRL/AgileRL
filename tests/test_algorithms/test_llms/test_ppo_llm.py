...
class TestPPOInit:
    ...
    def test_init_advantage_granularity_turn(self):
        ppo = _cpu_llmppo(advantage_granularity="turn")
...
class TestPPOTest:
    ...
    def test_test_method_rollout_continues_when_not_done(self):
        ...
        with patch.object(
            ...
            out = ppo.test(DummyRolloutContinueEnv(), loop=1)
...
class TestPPOColocatedVllm:
    ...
    def test_colocated_learn_with_trainer_offload(self, pretrained_model_name_or_path):
        ...
        argument, ``offload_trainer_during_rollout`` left at its default — the
        ...
        assert ppo.offload_trainer_during_rollout
