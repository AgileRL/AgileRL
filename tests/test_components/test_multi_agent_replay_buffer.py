...
class TestMultiAgentReplayBufferInit:
    ...
    def test_initialize_instance_with_valid_arguments(self):
        memory_size = 100
...
class TestMultiAgentReplayBufferLen:
...
class TestMultiAgentReplayBufferAdd:
    ...
    def test_append_to_memory_deque(self):
        memory_size = 100
        field_names = ["state", "action", "reward"]
        agent_ids = ["agent1", "agent2"]
    ...
    def test_add_experience_when_memory_full(self):
        memory_size = 2
        field_names = ["state", "action", "reward"]
        agent_ids = ["agent1", "agent2"]
...
class TestMultiAgentReplayBufferSaveToMemory:
    # Can add experiences to memory using save_to_memory method
    def test_add_experiences_to_memory(self):
        memory_size = 100
        field_names = ["state", "action", "reward"]
        agent_ids = ["agent1", "agent2"]
    ...
    def test_add_any_experiences_to_memory(self):
        memory_size = 100
        field_names = ["state", "action", "reward"]
        agent_ids = ["agent1", "agent2"]
        device = "cpu"
...
class TestMultiAgentReplayBufferSaveToMemorySingleEnv:
    # Can add single experiences to memory with save_to_memory_single_env method
    def test_add_single_experiences_to_memory(self):
        memory_size = 100
        field_names = ["state", "action", "reward"]
        agent_ids = ["agent1", "agent2"]
        device = "cpu"
...
class TestMultiAgentReplayBufferSaveToMemoryVectEnvs:
    # Can add multiple experiences to memory with save_to_memory_vect_envs method
    def test_add_multiple_experiences_to_memory(self):
        memory_size = 100
        field_names = ["state", "action", "reward"]
        agent_ids = ["agent1", "agent2"]
        device = "cpu"
...
class TestMultiAgentReplayBufferSample:
    ...
    def test_add_and_sample_vect_experiences_to_memory(self):
        memory_size = 100
        ...
        for agent in sampled_environments:
            for idx, env in enumerate(sampled_environments[agent]):
                assert (
                    states[agent][int(env)] == sampled_states[agent][idx].cpu().numpy()
                )

    # Can sample experiences from memory using sample method
    def test_sample_experiences_from_memory(self):
        memory_size = 100
        field_names = ["state", "action", "reward"]
        agent_ids = ["agent1", "agent2"]
...
class TestMultiAgentReplayBufferProcessTransition:
    ...
    def test_returns_np_transition_dictionary(self):
        memory_size = 100
    ...
    def test_returns_np_transition_asingle_experience_dictionary(self):
        memory_size = 100
        field_names = ["state", "action", "reward", "next_state", "done"]
        agent_ids = ["agent1", "agent2"]
    ...
    # Can process a transition from experiences and return a dictionary of numpy arrays.
    def test_returns_np_transition_dictionary_images(self):
        memory_size = 100
        field_names = ["state", "action", "reward", "next_state", "done"]
        agent_ids = ["agent1", "agent2"]
        ...
        assert transition["action"]["agent1"].shape == (len(experiences), 1)
        assert transition["reward"]["agent1"].shape == (len(experiences), 1)
        assert transition["next_state"]["agent1"].shape == (
            len(experiences),
            3,
            128,
            128,
    ...
    @pytest.mark.gpu
    def test_returns_torch_transition_dictionary(self):
        memory_size = 100
        field_names = ["state", "action", "reward", "next_state", "done"]
        agent_ids = ["agent1", "agent2"]
