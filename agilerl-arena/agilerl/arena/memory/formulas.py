...
def zero3_packed_moe_backward_bytes(
    ...
    one. Zero under contracted dispatch (the low-rank delta is formed by
    contraction, never the effective weight), when nothing targets the packed
    experts, or off ZeRO-3 — ZeRO-2 measured no surcharge on the same model.
    """
