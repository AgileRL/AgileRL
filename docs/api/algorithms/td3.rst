...
`TD3 <https://arxiv.org/abs/1802.09477>`__ is an extension of :ref:`DDPG <ddpg>` that addresses overestimation bias by introducing an extra
...
TD3 allows actor networks that are not :ref:`DeterministicActor <actors>`. If you use a custom actor,
