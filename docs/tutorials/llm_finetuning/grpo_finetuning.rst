...
.. collapse:: Custom Training Loop
    ...
    .. code-block:: python
        ...
        # One RolloutEnv per grouped rollout, driven in lock-step
        env = BatchRolloutEnv(env_factory, agent.batch_size, agent.group_size)
        ...
        for i in range(max_steps):
            ...
            metrics = [learn_metrics["mean_loss"], learn_metrics["mean_kl"], episode_scores]
