...
using an **Acrobot** environment as our example.
...
Our agent controls a two-link acrobot: it applies torques to the actuated joint to swing
the free end above a target height. The environment follows the standard Gymnasium interface
with a discrete action space (three torque levels).

The environment source lis taken from
`Gymnasium's Acrobot <https://github.com/Farama-Foundation/Gymnasium/blob/main/gymnasium/envs/classic_control/acrobot.py>`_.

.. collapse:: acrobot.py

   .. literalinclude:: /_static/examples/acrobot.py
      :language: python
...
The ``acrobot.py`` file defines a single Gymnasium environment class, ``AcrobotEnv``,
...
.. tab-set::
   ...
   .. tab-item:: Python
      ...
      .. code-block:: python
         ...
         client.create_project(name="Acrobot Tutorial")
   ...
   .. tab-item:: CLI
      ...
      .. code-block:: bash
         ...
         arena projects create "Acrobot Tutorial"
...
train a ``PPO`` agent on this classic-control task. We define the training configuration in a YAML manifest
(``acrobot_ppo.yaml``). Note how in the ``environment`` section we reference the validated environment by its
name as seen on Arena. If no version is specified, the latest one is used.

.. collapse:: acrobot_ppo.yaml

   .. literalinclude:: /_static/examples/acrobot_ppo.yaml
      :language: yaml
   ...
   .. tab-item:: Python
      ...
      .. code-block:: python
         ...
         result = client.submit_experiment(
             ...
             experiment_name="acrobot-ppo-v1",
         )
   ...
   .. tab-item:: CLI
      ...
      .. code-block:: bash
         ...
         arena experiments submit docs/_static/examples/acrobot_ppo.yaml \
             ...
             --num-nodes 2 \
             --project 'Acrobot Tutorial' \
             --experiment-name acrobot-ppo-v1
...
.. tab-set::
   ...
   .. tab-item:: CLI
      ...
      .. code-block:: bash
         ...
         # Download metrics
         arena experiments metrics acrobot-ppo-v1 --output-file metrics.csv

         # List checkpoints
         arena experiments checkpoints acrobot-ppo-v1
...
.. tab-set::
   ...
   .. tab-item:: Python
      ...
      .. code-block:: python
         ...
         client.deploy_agent(experiment_name="acrobot-ppo-v1")
   ...
   .. tab-item:: CLI
      ...
      .. code-block:: bash
         ...
         # Deploy the best checkpoint
         arena agent deploy acrobot-ppo-v1

         # Deploy a specific checkpoint
         arena agent deploy acrobot-ppo-v1 --checkpoint step_500000
...
.. code-block:: python
   ...
   agent = Agent(experiment_name="acrobot-ppo-v1")
