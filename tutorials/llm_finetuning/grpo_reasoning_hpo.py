...
def main(init_hp, mut_p):
    ...
    # Reasoning folds into the single-turn rollout taxonomy: a prompt dataset is
    # just an env. The BatchRolloutEnv owns the dataset cursor, keeping each GRPO
    # group's dataset order deterministic and consistent.
    class PromptDataset:
