...
def _label_with_episode_number(frame, episode_num, frame_no):
    ...
    drawer.text((700, 5), "Self-Play", fill=text_color, font=font)
    return im
...
if __name__ == "__main__":
    ...
    path = "./models/Rainbow_DQN/Rainbow_DQN_self_play_trained_agent.pt"
    ...
    imageio.mimwrite(
        os.path.join("./videos/", "connect_four_rainbow_self_play.gif"),
        frames,
        duration=300,
    )
