...
from agilerl.utils.population_utils import release_agent, release_agents, scalar_fitness
...
class TournamentSelection:
    ...
    def _select_llm_agents(
        ...
        unwanted_refs = [
            agent_slots[old_population_idxs.index(agent_idx)]
