...
def resolve_accelerator(
    ...
    :param algorithm: Algorithm spec for the job.
    :type algorithm: AlgoSpec
    :param accelerator: Caller-provided accelerator, or ``None``.
    :type accelerator: Accelerator | None
    :return: The accelerator to use, or ``None`` outside ``accelerate launch``.
