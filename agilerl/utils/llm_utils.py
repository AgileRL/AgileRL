...
def resolve_attn_implementation(requested: str | None = None) -> str:
    ...
    from agilerl.memory.formulas import resolve_attn_implementation as resolve
...
def resolve_vllm_max_num_batched_tokens(
    ...
    """
    from agilerl.memory.formulas import resolve_max_num_batched_tokens as resolve
