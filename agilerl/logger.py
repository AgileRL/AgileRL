...
class MutationHistoryLogger(Logger):
    ...
    FIELDNAMES: ClassVar[list[str]] = [
        ...
        "reborn_neurons_reborn",
        "reborn_neurons_xavier_reset",
        "reborn_overactive_count",
        "reborn_dormant_count",
        "fitness_before",
        "score_before",
        "fitness_after",
        "score_after",
    ...
    def _build_row(
        ...
        *,
        ...
        return {
            ...
            "reborn_neurons_reborn": details.get("neurons_reborn", ""),
            "reborn_neurons_xavier_reset": details.get("neurons_xavier_reset", ""),
            "reborn_overactive_count": details.get("overactive_count", ""),
            "reborn_dormant_count": details.get("dormant_count", ""),
            "fitness_before": fitness_before,
            "score_before": score_before,
            "fitness_after": fitness_after,
            "score_after": score_after,
