...
OfflineDataset = h5py.File | Mapping[Any, Any]

logger = logging.getLogger(__name__)


def load_offline_transitions(dataset: OfflineDataset, memory: ReplayBuffer) -> None:
    """Copy HDF5 or in-memory transitions into ``memory``."""
...
def train_offline(
    ...
    :param dataset: Open HDF5 handle or in-memory array mapping, defaults to None
    :type dataset: OfflineDataset | None, optional
    ...
    if minari_dataset_id:
        ...
        # Dict mappings have no file handle; OfflineStrategy passes an HDF5 file.
