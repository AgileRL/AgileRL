...
from agilerl.typing import ObservationType, DeviceType
from agilerl.modules import EvolvableModule

def to_evolvable(module_fn: Callable[[], nn.Module], module_kwargs: Dict[str, Any], device: DeviceType) -> EvolvableModule:
...
class DummyEvolvable(EvolvableModule):
    ...
    def __init__(self, module_fn: Callable[[], nn.Module], module_kwargs: Dict[str, Any], device: DeviceType) -> None:
