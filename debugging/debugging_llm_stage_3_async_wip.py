...
def evaluate_accuracy(
    ...
    if _uses_async_vllm(agent):
        ...
        return asyncio.run(_run_async_eval())
...
def detailed_eval(
    ...
    if _uses_async_vllm(agent):
        ...
        return asyncio.run(_run_async_detailed())
...
def run_single_seed(cfg: dict, seed: int) -> tuple[float, float]:
    ...
    try:
        ...
        if hasattr(agent, "_shutdown_async_vllm_resources"):
            agent._shutdown_async_vllm_resources()
